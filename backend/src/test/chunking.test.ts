...
describe('ChunkingService', () => {
  ...
  it('should create chunks of appropriate size', () => {
    const longText = 'This is a test sentence that will be repeated many times to create a large enough text for multiple chunks. '.repeat(25);
  ...
  it('should attempt to respect sentence boundaries', () => {
    ...
    const sentence = "This is a long sentence that stays together because it is one unit of thought. ";
    const longTextWithBoundaries = sentence.repeat(30);
    const chunksWithBoundaries = chunkingService.chunkText(longTextWithBoundaries);
  ...
  it('should have overlap between consecutive chunks', () => {
    const longText = 'Sentence A. Sentence B. Sentence C. Sentence D. Sentence E. '.repeat(30);
    const chunks = chunkingService.chunkText(longText);
